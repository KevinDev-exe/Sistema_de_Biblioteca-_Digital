"""
Django settings for Sistema_de_Biblioteca_Digital project.
...
SECRET_KEY = 'django-insecure-hb=9cazw!fs$cx7t3(5d^owh97!thl5xf&#@tn4!p*3iaq(l4+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Permitir todos los hosts para facilitar el despliegue en PythonAnywhere
ALLOWED_HOSTS = ['*']
